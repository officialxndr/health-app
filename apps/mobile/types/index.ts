...
export interface SyncMeta {
  localId: string       // UUID — SQLite primary key, stable React key
  serverId: string | null  // server cuid, null until synced
  syncStatus: SyncStatus
  updatedAt: string     // ISO timestamp for last-write-wins conflict resolution
}
